# -*- coding: utf-8 -*-
"""plasmonic nanoparticles_jrVAE_test.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fRLyPL_rp5q6H_VEeDGFcAVVkozOg6Fr
...
imstack = np.load("plasmonic_data.npy")
cluster_info = np.load("plasmonic_labels.npy")
#normdata = (imstack[1,:,:]-np.min(imstack[1,:,:]))/(np.max(imstack[1,:,:]) - np.min(imstack[1,:,:]))
a = plt.imshow(imstack[110,:,:])
#a = plt.imshow(normdata)
plt.colorbar(a)
...
#np.random.seed(10)
#n_data = 1000
#idx = np.random.randint(0, len(train_syndata), n_data)
#train_syndata_ss = train_syndata[idx]
#labels_syndata_ss = labels_syndata[idx]
#print(train_syndata_ss.shape, labels_syndata_ss.shape)
...
#train_syndata_ss = train_syndata_ss.float()
...
train_loader_full = pv.utils.init_dataloader(train_syndata, batch_size=batch_size)
